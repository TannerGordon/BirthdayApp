...
import { StyleSheet, Modal, View, Text, TouchableOpacity, Touchable } from "react-native";
...
export const Reminder = ({ navigation, route }: any) => {
  ...
  const addElement = () => {
    var pickerData=['2 days', '3 days', '4 days', '5 days', '6 days', '7 days', '8 days', '9 days', '10 days', '11 days', '12 days', '13 days', '14 days', '15 days', '16 days', '17 days', '18 days', '19 days', '20 days', '21 days', '22 days', '23 days', '24 days', '25 days', '26 days', '27 days', '28 days', '29 days', '30 days'];
    ...
    var newArray = [...exampleState , { id : newStr, text : "Custom", custom : true}];
    let num: any = idx;
...
/> */}
      ...
      <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Picker
              ...
              pickerData={['2 days', '3 days', '4 days', '5 days', '6 days', '7 days', '8 days', '9 days', '10 days', '11 days', '12 days', '13 days', '14 days', '15 days', '16 days', '17 days', '18 days', '19 days', '20 days', '21 days', '22 days', '23 days', '24 days', '25 days', '26 days', '27 days', '28 days', '29 days', '30 days']}
              onValueChange={value => { setCustomDate(value) }}
            />
            <TouchableOpacity
              style={styles.selectBtn}
              onPress={() => {setModalVisible(!modalVisible); addElement(); }}
            >
      ...
      <SafeAreaView style={styles.safeContainer}>
        <FlatList
          ...
          renderItem = {item => (reminderItem(item.item.text, item.item.custom, item.item.id))}
